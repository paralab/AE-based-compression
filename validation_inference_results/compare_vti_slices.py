...
def create_comparison_plots():
    ...
    # File paths
    original_file = "sample_094_original.vti"
    reconstructed_file = "sample_094_reconstructed.vti"
    ...
    plt.savefig('vti_comparison_slices.png', dpi=300, bbox_inches='tight')
    plt.savefig('vti_comparison_slices.pdf', bbox_inches='tight')
    print(f"\nSaved main comparison plot: vti_comparison_slices.png")
    ...
    for axis_idx, (axis_name, positions) in enumerate(zip(axes_names, [x_positions, y_positions, z_positions])):
        ...
        plt.tight_layout()
        filename = f'vti_comparison_{axis_name.lower().replace("-", "_")}_detailed.png'
    ...
    plt.tight_layout()
    plt.savefig('vti_comparison_profiles.png', dpi=300, bbox_inches='tight')
    print("Saved profile comparison plot: vti_comparison_profiles.png")
    plt.close()
    ...
    with open('comparison_statistics.txt', 'w') as f:
    ...
    print("Saved statistics to: comparison_statistics.txt")
