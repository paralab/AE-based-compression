#!/usr/bin/env python3
"""
SWAE 3D Ultra-Fast Training Script for U_CHI Dataset (5x5x5 Version)
Trains on 5x5x5 blocks with ultra-optimized INT8 quantized MLP architecture
~4K parameters, 50-100x speedup, minimal memory footprint
...
def main():
    parser = argparse.ArgumentParser(description='Train SWAE 3D for U_CHI Dataset (5x5x5 Version)')
    ...
    parser.add_argument('--arch', type=str, default='mlp_opt',
                        choices=['conv', 'mlp', 'gmlp', 'mlp_opt'],
                        help='Network backbone: conv, mlp, gmlp, or mlp_opt (ultra-fast INT8)')
    
    # Training parameters (optimized for ultra-fast model)
    parser.add_argument('--batch-size', type=int, default=4096,
                        help='Batch size for training (large for ultra-fast model)')
    parser.add_argument('--epochs', type=int, default=60,
                        help='Number of training epochs (fewer needed for simple model)')
    parser.add_argument('--lr', type=float, default=1e-3,
                        help='Learning rate (higher for simple model)')
    ...
    parser.add_argument('--save-dir', type=str, default='./save/swae_u_chi_5x5x5_mlp_opt',
    ...
    print("Creating U_CHI 5x5x5 datasets...")
