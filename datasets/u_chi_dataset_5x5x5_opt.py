#!/usr/bin/env python3
"""
U_CHI Dataset for SWAE 3D Training (5x5x5 Version)
Loads U_CHI variable from GR simulation HDF5 files and extracts 5x5x5 center crop
Data shape: (num_samples, 1, 5, 5, 5) extracted from original (num_samples, 1, 7, 7, 7)
"""
...
class UCHIDataset5x5x5(Dataset):
    """
    ...
    def __init__(self, data_folder, split='train', train_ratio=0.8, val_ratio=0.15,
        ...
        print(f"U_CHI Dataset (5x5x5) initialized:")
        print(f"  Split: {split}")
    ...
    def _load_u_chi_data(self):
        """Load U_CHI data from all HDF5 files and extract 5x5x5 center crop"""
        # Find all HDF5 files
        ...
        print(f"Final U_CHI data shape: {cropped_data.shape}")
...
def create_u_chi_5x5x5_datasets(data_folder, train_ratio=0.8, val_ratio=0.15, normalize=True, normalize_method='minmax', shuffle=True, seed=42):
    """
    ...
    train_dataset = UCHIDataset5x5x5(
...
create_u_chi_datasets = create_u_chi_5x5x5_datasets
...
if __name__ == "__main__":
    ...
    print("Testing U_CHI 5x5x5 dataset...")
    ...
    print("\nU_CHI 5x5x5 dataset test completed successfully!") 