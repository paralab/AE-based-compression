...
class SWAE3D5x5x5(nn.Module):
    ...
    def __init__(self, channels=[32, 64, 128, 256], latent_dim=16, lambda_reg=0.9):
        ...
        self.encoder = SWAE3DEncoder5x5x5(channels, latent_dim)
        self.decoder = SWAE3DDecoder5x5x5(list(reversed(channels)), latent_dim)
...
def create_swae_3d_5x5x5_model(latent_dim=16, lambda_reg=10.0, encoder_channels=None):
    """
